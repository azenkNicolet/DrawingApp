...
class MainActivity : AppCompatActivity() {
    ...
    val requestPermission : ActivityResultLauncher<Array<String>> =
        registerForActivityResult(ActivityResultContracts.RequestMultiplePermissions())
        {
            ...
            permissions.entries.forEach{
                ...
                {
                    Toast.makeText(
                        this, "Permission granted. You can read the storage files",
                ...
                else
                {
                    ...
                    {
                        Toast.makeText(this, "You denied read permission for external storage",
                        Toast.LENGTH_LONG).show()
                    }
                }
            }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //LinearLayout that contains all of our colors.
        val linearLayoutPaintColors = findViewById<LinearLayout>(R.id.ll_paint_colors)

        //Set default color black which is at position 2. 0 based index.
    ...
    private fun requestStoragePermission()
    {
        ...
        {
            showRationaleDialog("Kids Drawing App", "Kids Drawing App needs to access " +
